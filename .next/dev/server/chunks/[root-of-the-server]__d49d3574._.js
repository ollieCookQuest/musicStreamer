...
"[project]/src/app/api/sonos/control/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    ...
    try {
        if (command) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sonos$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendControl"])(groupId, command);
        } else if (volume) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sonos$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["setVolume"])(groupId, parseInt(volume));
        } else if (favoriteId) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sonos$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["loadFavorite"])(groupId, favoriteId);
            // Start playback immediately after loading the favorite
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sonos$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendControl"])(groupId, "play");
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sonos$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["setPlayModes"])(groupId, currentShuffle, currentRepeat);
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d49d3574._.js.map