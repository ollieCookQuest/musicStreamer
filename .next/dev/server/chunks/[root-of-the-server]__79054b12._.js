...
"[project]/src/app/api/sonos/library/search/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function extractAccountFromFavorites(favorites) {
...
function extractAccountFromPlayback(playbackState) {
    ...
    try {
        ...
        if (!accountId) {
            ...
            try {
                ...
                const spotifyAccount = musicAccounts.find((acc)=>acc.serviceId === "9");
                if (spotifyAccount) {
                ...
                try {
                    const favoritesData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sonos$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchFavorites"])(householdId);
                ...
                if (!accountId) {
                    try {
                        const groupsData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sonos$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchGroups"])(householdId);
                        const groups = groupsData.groups || [];
                        if (groups.length > 0) {
                            const firstGroup = groups[0];
                            const playbackData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sonos$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getPlaybackStatus"])(firstGroup.id);
            ...
            try {
                ...
                try {
                    const favoritesData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sonos$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchFavorites"])(householdId);
                    const favorite = favoritesData.items?.find((fav)=>fav.itemId?.accountId === accountId);
        ...
        try {
            const searchResults = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sonos$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["searchMusicService"])(householdId, accountId, term.trim(), serviceId);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ...searchResults,
                accountId,
                serviceId
...
//# sourceMappingURL=%5Broot-of-the-server%5D__79054b12._.js.map